...
app.get('/postits', mySession, (req, res) => {
    ...
    if (id) {
        ...
        res.send(buildView(`<p>Welcome ${user.name} to POSTITS!</p>
                        ...
                        <div class="container-postits">
                        ${user.postits.map(postit => `<section class="postit">${postit.content} 
                        <form action="/postit/${postit.id}" method="POST">
...
app.post('/postit/:id',  mySession, (req, res) => {
