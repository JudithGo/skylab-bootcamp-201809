...
app.delete('/api/users/:id/postits/:idPostit', jsonBodyParser, (req, res) => {
    const { params: { id, idPostit }, headers: { authorization } } = req
    ...
    try {
        ...
        logic.removePostit(id, idPostit)
            .then(() =>
                res.json({
                    status: 'OK',
                    data: idPostit 
...
app.put('/api/users/:id/postits/:idPostit', jsonBodyParser, (req, res) => {
    const { params: { id, idPostit }, headers: { authorization }, body: {text} } = req
    ...
    try {
        ...
        logic.modifyPostit(id, idPostit, text)
            .then(() =>
                res.json({
                    status: 'OK',
                    data: idPostit 
