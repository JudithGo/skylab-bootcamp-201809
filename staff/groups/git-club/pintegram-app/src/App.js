...
class App extends Component {
    state = { error: null, post : false, otherUser: undefined}
    ...
    render() {
        ...
        return <div>
            ...
            <Route path="/user/:id" render={ ()=>logic.loggedIn && !post && !profile && otherUser ?  <OtherProfile id={this.props.match.params.id} onInitialize={this.state.otherUser}  onGoBack={this.handleGoBack2}/> :<Redirect to="/home"/>}/>
